...
import com.service.back.AppService;
import com.service.developer.AppCategoryService;
import com.service.developer.AppVersionService;
import com.service.developer.DataDictionaryService;
import com.untils.Constants;
import com.untils.PageSupport;
...
@Controller
@RequestMapping(value="/m/backend/app")
    ...
    public String checkSave(AppInfo appInfo){
        ...
        try {
            if(appService.updateSatus(appInfo.getStatus(),appInfo.getId())){
                return "redirect:/m/backend/app/list";
            }
        } catch (Exception e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
